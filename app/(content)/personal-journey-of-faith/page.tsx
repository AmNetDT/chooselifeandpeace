    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4 my-16 md:my-28 px-4 md:px-28">
        <div className="col-span-6 md:col-start-1 md:col-end-7">
          ...
          <p className="text-base md:text-lg font-bold tracking-widest leading-normal text-center">
            ...
            message of hope and encouragement to those who wear them. Sophia’s
            story is a testament to the power of God’s love. In founding
            ChooseLifeandPeace, she hopes to share that same love with others,
            reminding them that God has a purpose for every life, and that
            through faith in Jesus Christ, we can all experience true peace and
            joy.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-16 md:py-24">
        ...
        <div className="p-4 md:p-8 border-l-0 md:border-l-zinc-700 border-x-0 md:border-x-4">
          ...
          <p className="text-base leading-normal">
            ...
            encapsulates the essence of our mission. We trust in the
            Lord`&apos;`s guidance in all we do, and we believe that with Him as
            our anchor, we can face any storm and emerge victorious.`&quot;`
          </p>
        </div>
      </div>
