    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4 my-16 md:my-28 px-4 md:px-28">
        <div className="col-span-6">
          ...
          <br />
          4.2. Third-Party Analytics: We may use services like Google Analytics
          to gather data on website usage. You can disable cookies through your
          ...
          <p>6. Your Rights You have the right to: </p>
          <br />
          6.1. Access, update, or delete your personal information.
          <br /> 6.2. Opt-out of receiving promotional communications.
          <br />
